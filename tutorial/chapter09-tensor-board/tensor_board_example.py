...
if __name__ == "__main__":
    ...
    for i in range(max_steps):
        if i % 10 == 0:
            summary, acc = sess.run([merged, accuracy], feed_dict = feed_dict(False, dropout))
            ...
            if i % 100 == 99:
                ...
                summary, _ = sess.run([merged, train_step], feed_dict=feed_dict(True, dropout),
