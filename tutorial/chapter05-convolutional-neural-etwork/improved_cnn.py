...
if __name__ == "__main__":
    ...
    pool2 = tf.nn.pool(norm2, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding='SAME')
    ...
    while step < num_iter:
        ...
        preditions = sess.run([top_k_op], feed_dict={image_holder: image_batch, label_holder: label_batch})
